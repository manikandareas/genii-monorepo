...
import { Badge } from "@genii/ui/components/badge";
import { Button } from "@genii/ui/components/button";
import { Popover, PopoverContent, PopoverTrigger } from "@genii/ui/components/popover";
...
function NotificationDropdown() {
  ...
  return (
    <Popover>
      ...
      <PopoverContent className="w-80 p-1 bg-white" align="end">
